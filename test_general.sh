...
renombrar_archivo() { [[ -f "$FAKE_USB_DIR/file4/file4.txt" ]] && mv "$FAKE_USB_DIR/file4/file4.txt" "$FAKE_USB_DIR/file4/file4.jpg" && echo "🔁 Archivo renombrado." || echo "⚠️ El archivo file4.txt no existe."; }
